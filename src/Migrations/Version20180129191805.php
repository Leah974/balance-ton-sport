 ...
 */
class Version20180129191805 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP participant, CHANGE titre titre VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_participant DROP FOREIGN KEY FK_7E84A2849D1C3019');
        ...
        $this->addSql('ALTER TABLE evenement ADD participant LONGTEXT NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:object)\', CHANGE titre titre VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
